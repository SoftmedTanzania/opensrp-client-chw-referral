...
import org.smartregister.chw.referral.util.ConfigHelper;
...
public class BaseReferralRegisterFragmentModel implements BaseReferralRegisterFragmentContract.Model {

    @Override
    public RegisterConfiguration defaultRegisterConfiguration() {
        return ConfigHelper.defaultRegisterConfiguration(ReferralLibrary.getInstance().context().applicationContext());
    }
